...
import com.example.myproyectofinal.Json.Cuenta;
import com.example.myproyectofinal.Json.Info;
import com.example.myproyectofinal.Json.Json;
import com.example.myproyectofinal.List.MyAdapter;
import com.example.myproyectofinal.List.MyAdapterEdit;
import com.example.myproyectofinal.List.MyAdapterRemove;
...
public class ListMain extends AppCompatActivity {
    ...
    private int []imagen = { R.drawable.edit,R.drawable.trash};
    ...
    public void onBackPressed() {
        Intent intent = new Intent (ListMain.this, Login.class);
        startActivity( intent );
    }
}