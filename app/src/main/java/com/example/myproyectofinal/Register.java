...
import com.example.myproyectofinal.Encriptación.Sha1;
...
public class Register extends AppCompatActivity {
    ...
    public void Registrarse (View v){
        ...
        if("".equals(Name.getText().toString()) || "".equals(userName.getText().toString()) ||
                ...
                "".equals(Number.getText().toString()) || "".equals(Password.getText().toString()))
        {
            ...
            if(Name.length() > 22 || userName.length() > 20 ||
                ...
                try {
                    ...
                    Json json = new Json();
                    String textoJson = json.crearJson(ValorName, ValoruserName, ValorMail,
